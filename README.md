...
Всiм привiт! 👋
Тут зібрані найзрозуміліші, акуратні та практичні приклади основних патернів проектування на Python.
Все лаконічно, по суті і без нудоти — щоб ви змогли легко і швидко застосовувати патерни на практиці.
